...
export function ImageLinkCards({ richText, title, eyebrow, cards }: ImageLinkCardsProps) {
  return (
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex w-full flex-col items-center">
          <div className="flex flex-col items-center space-y-4 text-center sm:space-y-6 md:text-center">
            ...
            <h2 className="text-3xl font-semibold md:text-5xl text-balance">{title}</h2>
              ...
              {cards?.map((card, idx) => (
                <CTACard
                  ...
                  className={cn(
                    ...
                    idx === cards.length - 1 && 'lg:rounded-r-3xl lg:rounded-l-none',
